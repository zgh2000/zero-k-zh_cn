...
local function ShowWindowGeoConfig(name, modeNum, modeName, retreatPadding)
	...
	local function ApplyFunc()
		...
		local confirmation = WG.Chobby.ConfirmationPopup(FinalApplyFunc, i18n("settings_keep_settings"), nil, 315, 170, i18n("yes"), i18n("no"), FinalApplyFailureFunc, true, 5)
...
local function GetLobbyTabControls()
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_language"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_split_panel_mode"),
	...
	children[#children + 1] = ComboBox:New {
		...
		items = {i18n("settings_split_autodetect"), i18n("settings_split_always_two"), i18n("settings_split_always_one")},
	...
	children[#children + 1], children[#children + 2], offset = AddNumberSetting(offset, i18n("settings_lobby_interface_scale"), i18n("settings_lobby_interface_scale_desc"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_chat_font_size"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_menu_music_volume"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_notification_volume"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_background_brightness"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_game_overlay_opacity"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_coop_connection_delay"),

		tooltip = i18n("settings_tooltip_coop_delay"),
	...
	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_multiplayer_new_window"), "multiplayerLaunchNewSpring", true)
	...
	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_autosave_sp"), "autosaveOnMatchmaker", true)
	...
	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_friend_online_notify"), "friendNotifyIngame", true)
	...
	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_minimize_lobby"), "lobbyIdleSleep", true)
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_clear_channel_history"),
	...
	children[#children + 1] = Button:New {
		...
		tooltip = i18n("settings_tooltip_clear_history"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_delete_path_cache"),
	...
	children[#children + 1] = Button:New {
		...
		tooltip = i18n("settings_tooltip_delete_cache"),
...
local function GetVoidTabControls()
	...
	children[#children + 1] = TextBox:New {
		...
		text = i18n("settings_dev_warning"),
	...
	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_debug_server"), "activeDebugConsole", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_debug_chat"), "debugLobbyGameChat", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_debug_raw"), "debugRawMessages", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_debug_auto_win"), "debugAutoWin", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("simple_ai_list"), "simpleAiList2", true)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_debug_ingame"), "enableDebugBuffer", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_enable_inspector"), "enableInspector", false, EnableInspectorFunc)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_enable_profiler"), "enableProfiler", false, EnableProfilerFunc)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_show_planet_unlocks"), "showPlanetUnlocks", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_show_planet_codex"), "showPlanetCodex", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_show_planet_map"), "showPlanetMinimap", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_show_planet_enemies"), "showPlanetEnemyUnits", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_campaign_debug"), "campaignSpawnDebug", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_edit_campaign"), "editCampaign", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_show_bots"), "displayBots", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_show_wrong_engines"), "displayBadEngines3", true)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_debug_matchmaker"), "showMatchMakerBattles", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_hide_interface"), "hideInterface", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_neuter"), "doNotSetAnySpringSettings", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_aggressive_borderless"), "agressivelySetBorderlessWindowed", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_use_wrong_engine"), "useWrongEngine", false)

	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("settings_show_old_ai"), "showOldAiVersions", false)
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_disable_lobby"),
	...
	children[#children + 1] = Button:New {
		...
		caption = i18n("settings_disable"),

		tooltip = i18n("settings_tooltip_disable_lobby"),
		...
		OnClick = {
			...
			function (obj)
				...
				WG.Chobby.ConfirmationPopup(DisableAllWidgets, i18n("settings_confirm_disable"), nil, 315, 170, i18n("yes"), i18n("cancel"))
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_singleplayer"),
	...
	children[#children + 1] = Label:New {
		...
		caption = i18n("settings_campaign"),
...
local function MakePresetsControl(settingPresets, offset)
	...
	local customSettingsButton = SettingsButton(x, y, i18n("settings_custom"))
