...
local function GetProfileHandler()
	...
	function externalFunctions.UpdateProfile(profileData)
		...
		rankBar = rankBar or MakeProgressBar("48%", "您的技能评级和到下一段位的进度。")
...
local function InitializeControls(window)
	...
	AddLinkButton(lowerLeft, "编辑指挥官", "Edit custom commanders for use in games on the Zero-K server.",


		"https://zero-k.info/My/Commanders", true, 0, 0, 0, "80.5%")


	AddLinkButton(lowerLeft, "天梯评分",  "View detailed ladder statistics and charts.",


		"https://zero-k.info/Charts/Ratings?RatingCategory=1&UserId=_USER_ID_", true, 0, 0, "20.5%", "60.5%")


	AddLinkButton(lowerLeft, "回放列表",     "View and comment on your recent games on the Zero-K server.",
	...
	AddLinkButton(lowerLeft, "最近帖子",    "View your recently posted in forum threads.",
	...
	AddLinkButton(lowerLeft, "联系管理员",       "Send a non-report message to the moderation team. If instead you want to report a player, click on their name and select 'Report' from the dropdown menu.",
