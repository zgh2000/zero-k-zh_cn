...
local function InitializeControls(window)
	...
	local headings = {
		...
		{name = "顺序", x = 5, width = 2*BUTTON_WIDTH + 7},

		{name = "名称", x = 2*BUTTON_WIDTH + 12, width = STATUS_POSITION - 2*BUTTON_WIDTH - 9},

		{name = "状态", x = STATUS_POSITION + 3, right = 5},
